...
class historyBodyView extends StatefulWidget {
final Record newrec;
  const historyBodyView({Key? key,required this.newrec}) : super(key: key);

  @override
  State<historyBodyView> createState() => _historyBodyViewState();
}

class _historyBodyViewState extends State<historyBodyView> {
    ...
    return Scaffold(
            ...
            ElevatedButton(
                ...
                onPressed: () {
                  setState(() {
                    ...
                    _controller.deleteRecord(widget.newrec);
      ...
      bottomNavigationBar: AnimatedBottomNavigationBar(height:Get.height/12,gapLocation: GapLocation.center,
        ...
        onTap: (p0) {
          setState(() {
            _currentTab=p0;
_currentTab==0?Get.to(GraphScreen()):_currentTab==1?Get.to(HistoryScreen()):null;
          });
        },
      ),
